  ...
  const data = {
    ...
    faq:
      homepage?.faq && homepage.faq.length > 0
        ? homepage.faq.map((f) => ({ question: f.question, answer: f.answer }))
        : [
            { question: "器材借用要怎麼申請？", answer: "請由「器材借用」進入借用系統，選擇品項與時段後送出申請。" },
            { question: "借用有押金嗎？", answer: "本平台器材借用不收押金，但需具傳院師生身分，並遵守借還規範。" },
            { question: "電腦教室的開放時間？", answer: "開放時段依學期課表調整，請見「場地借用」的開放時段。" },
            { question: "要怎麼加入 ITLab？", answer: "每學年招新期間會公告報名方式，歡迎關注橫幅的招新資訊。" },
          ],
